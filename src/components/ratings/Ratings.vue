    ...
    <!-- </div> -->
        ...
        <div class="content">
            ...
            <ul class="rating-list" >
                   ...
                   v-for="(comment,index) in selectComments" :key="index">
...
export default {
    ...
    computed:{
        selectComments(){
            ...
            }else if(this.selectType == Pictuer){
                let arr = []
