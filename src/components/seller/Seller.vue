    ...
    <div class="seller">
        <div class="seller-wrapper" ref="sellerView">
            ...
            <div class="pics-wrapper" ref="picsView" v-if="seller.poi_env">
                ...
                class="pics-list">
                    <li ref="picsItem"
                    v-if="seller.poi_env"  v-for="(imgurl,index) in seller.poi_env.thumbnails_url_list" :key="index"
                    class="pics-item">
                        <img :src="imgurl" alt="">
                    </li>
                </ul>
            ...
            <div class="other-wrapper">
                <div class="server-wrapper">
                    商家服务
                    <div v-for="(item,index) in seller.poi_service" :key="index"
                    class="poi-server">
                    <img :src="item.icon" alt="">{{item.content}}
                    </div>
                </div>
                <div class="discounts-wrapper">
                    <div v-for="(item,index) in seller.discounts2" :key="index" 
